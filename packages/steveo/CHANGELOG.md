...
- cd06bd7: Stop Kafka consumers redelivering messages after a batch or a rebalance
...
- 551670b: Support QUEUE_PREFIX and CONSUMER_GROUP_PREFIX environment variables
