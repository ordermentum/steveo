...
// Pinned to a non-zero millisecond on purpose. computeNextRun derives DTSTART
// at second precision, so on an exact second it returns the current instant
// rather than the next run - do not round this to .000.
